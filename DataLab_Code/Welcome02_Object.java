...
public class Welcome02_Object {
   public static void main(String[] args) {
      String id1 = "KPOF";
      DataSource ds1 = DataSource.connect("http://weather.gov/xml/current_obs/" + id1 + ".xml").load(); 
      ...
      String id2 = "KSAV";
      DataSource ds2 = DataSource.connect("http://weather.gov/xml/current_obs/" + id2 + ".xml").load(); 
      ...
      String id3 = "KSTL";
      DataSource ds3 = DataSource.connect("http://weather.gov/xml/current_obs/" + id1 + ".xml").load(); 
      ds1.setCacheTimeout(15 * 60);  
      ds1.load();
      //ds1.printUsageString();
